"use strict";
class Slide {
    constructor(slidePages, prevButton, nextButton, paginationDots) {
        this.slideCurrent = 0;
...
new Slide(".main__home-article carousel_slide .slide__page", ".main__home-article .carousel_prev-button", ".main__home-article .carousel_next-button", ".main__home-article .carousel__pagination .dot");
